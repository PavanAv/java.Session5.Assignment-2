public class HighRiseBuilding extends Building{
	...
	boolean hasSpa;		
	public HighRiseBuilding(int noOfFloors, int noOfRooms, int noOfBathrooms, String buildingName,boolean hasGatedSecurity, boolean hasStore, int noOfFlats, boolean hasSwimmingPool,
	boolean hasSpa) {		
