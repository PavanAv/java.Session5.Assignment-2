public class LowRiseBuilding extends Building {
	...
	boolean hasStore;		
	public LowRiseBuilding(int noOfFloors, int noOfRooms, int noOfBathrooms, String buildingName,boolean hasGatedSecurity, boolean hasStore) {
	...
	if (hasStore) 			
	System.out.println("Building has a store!");		
	else System.out.println("Building doesn't have a  store!");
	}
}
