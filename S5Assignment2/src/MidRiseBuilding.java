public class MidRiseBuilding extends Building{
	...
	public MidRiseBuilding(int noOfFloors, int noOfRooms, int noOfBathrooms, String buildingName,boolean hasGatedSecurity, boolean hasStore, int noOfFlats, boolean hasSwimmingPool) {		
